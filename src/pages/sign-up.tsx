...
const SignUpPage: React.FC = () => {
    ...
    function handleOnNumberClick(num: string) {
        ...
        <form onSubmit={handleOnSubmit}>
            <DefaultContainer>
                ...
                <RightCard>
                    ...
                    <Qwerty onKeyClick={handleOnNumberClick} onClearClick={handleOnClearClick} onDeleteClick={handleOnDeleteClick}/>
                    <DefaultButton label={"Sign-Up"} onClick={handleOnCheckInClick}/>
                    <br />
                    <a href={"/"}>Check-In</a>
                    <br />
